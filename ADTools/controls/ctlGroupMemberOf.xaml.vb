...
Public Class ctlGroupMemberOf
    ...
    Public Async Sub InitializeAsync()
        If _currentobject Is Nothing And _currentdomain Is Nothing Then Exit Sub
    ...
    Private Sub AddMember([object] As clsDirectoryObject)
        Try
            ...
            If Mode = enmMode.ObjectMemberOf Then
                ...
                [object].UpdateAttribute(DirectoryServices.Protocols.DirectoryAttributeOperation.Add, "member", _currentobject.distinguishedName)
            ...
            ElseIf Mode = enmMode.DomainDefaultGroups Then
                ...
                _currentdomain.DefaultGroups = _currentdomain.DefaultGroups ' magic to call setter
                lvSelectedGroups.Items.Add([object])
    ...
    Private Sub RemoveMember([object] As clsDirectoryObject)
        Try
            If Mode = enmMode.ObjectMemberOf Then
                ...
                [object].UpdateAttribute(DirectoryServices.Protocols.DirectoryAttributeOperation.Delete, "member", _currentobject.distinguishedName)
